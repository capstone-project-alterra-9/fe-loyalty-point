...
const Sidebar = () => {
  return (
    <>
      <div
        className="col-auto bg-sbar min-vh-100"
      >

          <div >
            <ul className="nav flex-column mt-5 pt-5">
              <li>
              <NavLink  activeclassname="active" className="nav-link p-2 " to="/admin">
              {/* <NavLink style={({isActive})=>{return {background: isActive?'#425141':''}}} className="nav-link p-2 " to="/admin"> */}
                  <MdDashboard className="txt-color"/>
                  <span className=" p-2 m-3 d-none d-sm-inline txt-color">Dashboard</span>
                </NavLink>
              </li>

              <li>
              <NavLink  activeclassname="active" className="nav-link p-2" to="/admin/users">
              {/* <NavLink style={({isActive})=>{return {background: isActive?'#425141':''}}} className="nav-link p-2" to="/admin/users"> */}
                  ...
                  <span className="p-2 m-3 d-none d-sm-inline txt-color">Users</span>
                </NavLink>
              </li>
              ...
              <NavLink activeclassname="active" className="nav-link p-2" to="/admin/transactions">
                ...
                <button className="btn btn-toggle collapsed" data-bs-toggle="collapse" data-bs-target="#transaction-collapse" >
                ...
                <div className="collapse" id="transaction-collapse">
                  <ul className="btn-toggle-nav list-unstyled fw-normal">
                    <li>
                      <NavLink className="link-dark rounded p-2" to="/admin/transactions">
                      <BiDollarCircle className="txt-color"/>
                      <span className="p-2 m-3 d-none d-sm-inline txt-color">Buy</span>
                      </NavLink>
                    </li>
                    <li>
                      <NavLink className="link-dark rounded p-2" to="/admin/redeemtransactions">
                      <MdCardGiftcard className="txt-color"/>
                      <span className="p-2 m-3 d-none d-sm-inline txt-color">Reedem</span>
                      </NavLink>
                    </li>
                  </ul>
                </div>
              ...
              <li>
              <NavLink  activeclassname="active" className="nav-link p-2" to="/admin/products">
              {/* <NavLink style={({isActive})=>{return {background: isActive?'#425141':''}}} className="nav-link p-2" to="/admin/products"> */}
                  ...
                  <span className="p-2  m-3 d-none d-sm-inline txt-color">Products</span>
                </NavLink>
              </li>
              ...
              <li className="border-top my-3"></li>
                <li>
                  <Link className="nav-link">
                    ...
                    <span className="ms-1 d-none d-sm-inline txt-color">LOG OUT</span>
                  </Link>
                </li>
